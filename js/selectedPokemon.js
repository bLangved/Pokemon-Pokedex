import { getBackgroundColorForType, updateBodyColor } from "./utils/pokemonUtils.js";
import { findPreviousPokemonInChain, findNextPokemonInChain } from "./utils/evolutionPattern.js";
...
export function createSelectedPokemon (pokemon, evolutionChain){
    ...
    infoSection1.classList.add("selectedPokemon-infoSection", "selectedPokemon-infoSection1");
    ...
    let previousEvolutionName = findPreviousPokemonInChain(pokemon, evolutionChain);    
    pokemonPreviousStage.innerText = "Previous Evolution: " + (previousEvolutionName || "None"); 
    ...
    pokemonNextStage.innerText = "Next Evolution: " + (nextEvolutionName || "None"); 
    ...
    infoSection2.classList.add("selectedPokemon-infoSection", "selectedPokemon-infoSection2");
